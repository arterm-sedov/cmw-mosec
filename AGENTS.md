...
- **Planning:** Plan your course of action before implementing. Write a plan to `.opencode/plans/` that is lean, dry, TDD-first, and follows SDD/DDD/clean architecture principles.
